...
本应用是一款足球技术学习,足球训练记录,足球文章的应用
广场:推荐的文章,足球问答题
简文:所有的文章,您可以在此处浏览所有的文章
课程:您可以在技术课程中挑选您感兴趣的技术课程预约前往试听.训练:您可以记录您的训练
个人:您自己的资料简介.您预约的技术课程试听状态.技术课程的咨询.您的训练伙伴.您发表的文章.您喜爱的文章.您的问答题的成绩.反馈问题.退出登录.

如有问题请联系邮箱:xwq19750426@icloud.com
